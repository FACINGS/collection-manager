...
const eos = new JsonRpc(`${eosChain.rpcEndpoints[0].protocol}://${eosChain.rpcEndpoints[0].host}`, { fetch });

export async function getEosAccountInfo(activeUser, onInfoResponse = () => {}, error = () => {}) {
    try {
