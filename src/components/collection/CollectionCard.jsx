...
export function CollectionCard({ item, isTemplate }) {
  ...
  return (
    <div className="flex flex-col items-center m-4 w-fit h-fit">
      ...
      <div
        className={`w-40 h-fit shadow-md p-2 max-w-40 rounded-b-lg flex flex-col bg-primary text-white text-center items-center relative`}
      >
