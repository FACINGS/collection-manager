    ...
    return (
        <div className="flex flex-col md:max-w-auto max-w-fit">
            <div className="flex flex-col gap-8">
                <h1 className="text-xl font-bold">Schemas in the collection ({totalSchemas})</h1>              
                        ...
                        schemasList.map((schema, index) => {
                            return (
                                <div key={index} className="flex flex-col items-center m-4 w-fit h-fit">
                                    <div className={`w-40 h-fit shadow-md p-4 max-w-40 rounded-lg flex flex-col bg-primary text-white text-center items-center relative`}>
                                        <h3 className="text-xl font-bold bg-primary border-b-2 border-solid border-white w-full pb-2">{schema.schema_name}</h3>                      
                                        <div className="flex flex-col text-white text-center pt-2 w-full">                    
                                            <p className="text-base font-bold w-full truncate">{collection}</p>
