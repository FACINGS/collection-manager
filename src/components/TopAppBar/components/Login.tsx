...
function LoginComponent({ chainKey, ual }: LoginComponentProps) {
  ...
  return (
    <Menu as="div" className="relative">
      <Menu.Button className="flex gap-2 md:gap-1 items-center md:text-base text-2xl font-bold p-4 ui-open:text-white ui-not-open:text-zinc-400">
        {ual.activeUser.accountName}
        <CaretDown size={16} weight="bold" className="ui-open:rotate-180" />
      </Menu.Button>

      <Menu.Items className="absolute z-10 bg-zinc-800 top-14 md:right-0 right-4 rounded w-[calc(100%-2rem)] md:w-auto">
        <Menu.Item disabled>
          <div className="ui-active:bg-zinc-700 md:body-3 body-1 font-bold text-white p-4 border-b border-zinc-700">
        ...
        <Menu.Item>
          <button
            type="button"
            className="ui-active:bg-zinc-700 w-full md:body-2 body-1 font-bold px-8 py-4 rounded"
