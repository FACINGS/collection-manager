    ...
    return (
      <main className="container">
        <header className="mt-8 md:mt-12 lg:mt-16">
          <h1 className="headline-1 mb-2">Transfer</h1>
        ...
        <div className="flex md:flex-row flex-col gap-24 w-full md:my-16 my-8">
          <form
          ...
          >
            ...
            {selectedAssets.length > 0 ? (
              ...
              <div className="bg-neutral-800 px-8 py-16 text-center rounded-xl">
                <h4 className="title-1">There is no NFT selected</h4>
              </div>
            )}
            {isLoading ? (
